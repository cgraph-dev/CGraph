...
This release addresses **8 CRITICAL and HIGH severity security vulnerabilities** identified in our comprehensive security audit. **Immediate upgrade strongly recommended** for all users.
