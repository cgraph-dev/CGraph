...
Version 0.9.1 is a maintenance release focusing on **critical bug fixes, security hardening, and developer documentation**. This release addresses security vulnerabilities, adds production hardening features, and improves the developer experience.
...
- Expanded `security` workflow: gitleaks, hadolint, Sobelow, pnpm audit, SBOM generation, vulnerability scanning
