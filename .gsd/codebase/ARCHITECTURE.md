...
| `@cgraph/utils`               | Format, validation (Zod), permissions, HTTP client factory                                                                                                                                                                      | Web, Mobile, Landing |
| `@cgraph/ui`                  | Liquid Glass UI component library (button, card, modal, input, etc.)                                                                                                                                                            | None (unused)        |
