...
## Files Changed
- **Created:** 5 files (migration, web schedule panel, web toggle, mobile schedule screen, mobile toggle)
- **Modified:** 12 files (user_settings schema, settings context, controller, routes, presence channel, web settings panel/store/mappers, mobile settings screen/store/types)
