...
- **Commit:** `5acf558c`
- 11 animated CSS keyframes: pulse, rotate, shimmer, wave, breathe, spin, rainbow, particles, glow, flow, spark
...
- Rarity hierarchy: common (gray), uncommon (green), rare (blue), epic (purple gradient), legendary (gold gradient), mythic (pink→purple), unique (rainbow)
