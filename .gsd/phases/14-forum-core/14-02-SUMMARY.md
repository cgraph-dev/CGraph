...
- **File**: `apps/backend/priv/repo/migrations/20260301300001_add_forum_fulltext_search.exs` (170 lines)
...
- **Modified**: `apps/backend/lib/cgraph/forums/thread_posts.ex` (+35 lines) — thread & thread_post reputation
