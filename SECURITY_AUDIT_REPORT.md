...
This security audit identified **8 CRITICAL** and **14 HIGH** severity vulnerabilities in the CGraph messaging platform. Immediate action is required to address authentication token storage, cryptographic key management, and data exposure issues.
...
**Count**: 149 occurrences across 61 files
...
**Auditor Contact**: security@cgraph.com (replace with actual contact)
