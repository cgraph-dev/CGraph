...
tools: ['readFile', 'runInTerminal', 'listDirectory', 'textSearch', 'editFiles', 'runSubagent']
---

<objective>
Validate built features through conversational testing with persistent state.

Purpose: Confirm what Copilot built actually works from user's perspective. One test at a time,
plain text responses, no interrogation. When issues are found, automatically diagnose, plan fixes,
and prepare for execution.

Output: {phase}-UAT.md tracking all test results. If issues found: diagnosed gaps, verified fix
plans ready for /execute-phase.md </objective>

<execution_context> ../skills/verify-work/SKILL.md @.gsd/templates/UAT.md </execution_context>
...
@.gsd/STATE.md @.gsd/ROADMAP.md </context>
...
- [ ] Ready for `/execute-phase.md` when complete </success_criteria>
