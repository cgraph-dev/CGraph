...
For GitHub Copilot, GSD is distributed via the repository's `.github/` folder. Updates are pulled
via git. </objective>
...
STOP here if already up to date. </step>
...
Capture output. If pull fails (conflicts, etc.), show error and suggest resolution. </step>
