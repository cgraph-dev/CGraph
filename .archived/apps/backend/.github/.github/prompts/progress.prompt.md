...
If missing both ROADMAP.md and PROJECT.md: suggest `/new-project.md`. </step>
...
- Read `.gsd/config.json` for settings (model_profile, workflow toggles) </step>
...
- Check for CONTEXT.md: For phases without PLAN.md files, check if `{phase}-CONTEXT.md` exists in
  phase directory
...
- Handoff file exists → mention it, offer `/resume-work.md` </step>
