...
Factory is in `test/support/factory.ex` (785 lines) with factories for all domain entities: users,
admins, forums, threads, posts, messages, achievements, quests, avatar borders, user ownership
records, etc.
