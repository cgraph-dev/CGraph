...
> Auto-generated by codebase mapper. Last updated: 2026-03-04. Source of truth: actual
> `package.json`, `mix.exs`, config files, and infrastructure definitions. **App version**: `1.0.0`
> (bumped from 0.x — see `mix.exs` `@version`).
...
**Backend version**: `1.0.0` (`@version` in `mix.exs`)
...
- **Grafana Alloy** sidecar for metrics shipping ([`alloy/`](alloy/) — `config.alloy`,
  `start-with-app.sh`, `start.sh`)
