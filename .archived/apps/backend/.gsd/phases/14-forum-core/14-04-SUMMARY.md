...
Wire mobile forum features: BBCode renderer, centralized Zustand store, forum search screen, delete
confirmation flows, inline poll creation, and fix module exports.
...
- Supports: `[b]`, `[i]`, `[u]`, `[s]`, `[url]`, `[img]`, `[quote]`, `[code]`, `[list]`, `[color]`,
  `[size]`, `[spoiler]`, `[center]`, nested combinations
...
- Full CRUD actions: fetchForums, fetchForum, fetchBoards, fetchThreads, fetchPost, deletePost,
