...
patterns-established:
  - 'Group moderation controller: all actions require group membership + manage_messages/ban_members
    permission'
...
**Group moderation pipeline with structured kick/ban reasons, group-scoped report management, and
full report submission + ban management on both web and mobile.**
...
- Created groups/moderation.ex (232L): list_group_reports/2, review_group_report/4,
  get_group_report/2, group_moderation_stats/1
...
- Created report-content-screen.tsx (210L): 13 category pills, description textarea, submit via POST
  /api/v1/reports
- Created ban-list-screen.tsx (230L): Active bans with reason/expiry, unban with confirmation,
  pull-to-refresh
- Added ReportContent + BanList to GroupsStackParamList and navigator
- Enhanced group-moderation-screen.tsx: added Reports tab fetching from group-scoped endpoint with
  status badges
