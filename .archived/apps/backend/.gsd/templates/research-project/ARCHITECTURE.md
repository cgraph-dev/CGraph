...
**Domain:** [domain type] **Researched:** [date] **Confidence:** [HIGH/MEDIUM/LOW]
...
src/ ├── [folder]/ # [purpose] │ ├── [subfolder]/ # [purpose] │ └── [file].ts # [purpose] ├──
[folder]/ # [purpose] │ ├── [subfolder]/ # [purpose] │ └── [file].ts # [purpose] ├── [folder]/ #
...
**What:** [description] **When to use:** [conditions] **Trade-offs:** [pros and cons]
...
**What people do:** [the mistake] **Why it's wrong:** [the problem it causes] **Do this instead:**
