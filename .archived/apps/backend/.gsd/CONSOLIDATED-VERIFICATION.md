...
**Goal:** Users have profiles (avatar, bio, status), friend/block system, contact list with
presence, and QR code login.
...
**Expected requirements:** MSG-02, MSG-03, MSG-08, MSG-10, MSG-11, MSG-12, MSG-13, MSG-14, MSG-15,
