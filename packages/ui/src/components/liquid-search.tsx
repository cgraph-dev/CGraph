...
export const LiquidSearch = forwardRef<HTMLInputElement, LiquidSearchProps>(
  ({ className, value, onClear, inputSize = 'md', onChange, ...props }, ref) => {
          ...
          {hasValue && onClear && (
            <motion.button
              ...
              className={cn(
                ...
                'cursor-pointer hover:bg-slate-300/80',
...
LiquidSearch.displayName = 'LiquidSearch';
