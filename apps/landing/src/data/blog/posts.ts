...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'Phase 39 — Added SSO/SAML authentication, compliance tooling, audit logging with DB persistence, and admin dashboard panels. CGraph is now ready for organizational deployments.',
    category: 'Product',
    author: 'Burca Lucas',
  ...
  },
  {
    ...
    excerpt:
      'Phase 36 — Introduced the Nodes currency system with paid DMs, premium threads, content boosts, tipping, and revenue sharing. Creators now earn from their contributions to the platform.',
    category: 'Product',
    author: 'Burca Lucas',
