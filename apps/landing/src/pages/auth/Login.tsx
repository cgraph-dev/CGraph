/**
 * Login Page for CGraph Landing
 *
 * Redirects to the main web app for actual authentication
 * This is a gateway page that provides seamless UX from marketing to app
 */
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Redirect to web app with encoded credentials in state
    // The web app will handle the actual authentication
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-[#0a0a0f] px-4 text-gray-500">Or continue with</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-white transition-all hover:bg-white/10"
            title="Connect with Web3 Wallet"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
