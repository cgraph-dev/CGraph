...
export function ChannelHeader({
  ...
  return (
    <header className="flex h-12 items-center justify-between border-b border-white/[0.06] bg-white/[0.04] px-4">
      ...
      <div className="flex items-center gap-1">
        <button className="rounded p-1.5 text-gray-400 transition-colors hover:bg-white/[0.08] hover:text-white">
        ...
        <div className="relative mx-2">
          ...
          <input
            type="text"
            placeholder="Search"
            className="w-36 rounded bg-[rgb(30,32,40)] py-1 pl-8 pr-2 text-sm text-white placeholder-white/30 focus:outline-none focus:ring-1 focus:ring-primary-500"
          />
        </div>
      </div>
    </header>
