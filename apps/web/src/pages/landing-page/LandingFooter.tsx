 ...
 * Landing Page Footer
 *
 * Site-wide footer with product, resources, company, and legal
 * link columns, plus social media icons.
 *
 * @module pages/landing-page/LandingFooter
 */

import { Link } from 'react-router-dom';
import { LogoIcon } from '@/components/logo';
import { footerLinks } from '../landing';

/**
 * Landing page footer with four link columns and social icons.
 */
