        ...
        return (
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              ...
              />
              <p className="mt-1 text-right text-xs text-gray-500">{profileData.bio.length}/200</p>
            </motion.div>
                ...
                {(['dark', 'light', 'system'] as const).map((theme) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-sm font-medium capitalize text-gray-300">{theme}</span>
                    </div>
                  </button>
                ))}
              </div>
        ...
        return (
          ...
          >
            {[
              ...
              {
                key: 'notifyFriendRequests' as const,
          ...
          <div className="mb-8 text-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="mt-2 text-gray-400">{steps[currentStep - 1]?.description}</p>
              </motion.div>
            </AnimatePresence>
          </div>
