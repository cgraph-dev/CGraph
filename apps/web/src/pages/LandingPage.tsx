...
const securityFeatures = [
  ...
  { icon: '✅', title: 'Auditable Security', description: 'Transparent about our security practices' },
];
...
const highlights = [
  ...
  { value: 'Forums', label: 'Community Features' },
  { value: 'WebRTC', label: 'Voice & Video' },
];

// Testimonials - will add real ones when we have users
        ...
        >
          {highlights.map((item) => (
            <div key={item.label} className="text-center">
              <div className="mb-2 text-3xl font-bold text-white sm:text-4xl">{item.value}</div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mb-10 max-w-2xl text-xl text-gray-400">
            Join us in building the future of secure, privacy-first
            communication. Sign up to be among the first users.
          </p>
