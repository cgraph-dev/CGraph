/**
 * Media, voice, and file handler factories
...
const logger = createLogger('ConversationMediaHandlers');
...
export interface VoiceSendContext {
  conversationId: string;
  uiPreferences: UIPreferences;
  setIsSending: (value: boolean) => void;
...
export interface FileSendContext {
  conversationId: string;
  replyTo: Message | null;
  uiPreferences: UIPreferences;
  sendMessage: (
