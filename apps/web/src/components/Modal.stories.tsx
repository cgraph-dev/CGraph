...
const meta: Meta<typeof Modal> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Accessible modal component with keyboard navigation, focus trapping, and customizable sizes.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Small: Story = {
  args: {
    ...
    children: (
      <p className="text-gray-300">Are you sure you want to continue?</p>
    ),
    footer: (
...
export const DangerConfirmation: Story = {
  args: {
    ...
    children: (
      <div className="space-y-4">
        <p className="text-gray-300">
          Are you sure you want to delete <strong className="text-white">#general</strong>? 
    ...
    children: (
      <div className="grid grid-cols-3 gap-4">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div 
            key={i}
            className="aspect-video bg-dark-700 rounded-lg flex items-center justify-center text-gray-500"
          >
            Image {i}
          </div>
        ))}
