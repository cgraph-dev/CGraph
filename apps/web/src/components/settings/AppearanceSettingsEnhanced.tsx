...
function ThemeCard({ theme, isActive, onSelect, onDelete, isPremium }: ThemeCardProps) {
  ...
  return (
    <motion.button
      ...
      className={`
        relative w-full p-1 rounded-xl transition-all duration-300
        ${isActive 
    ...
    >
      ...
      >
        ...
        {/* UI Mock */}
        <div className="relative h-full p-2 flex flex-col gap-1">
          {/* Header */}
          <div 
          ...
          <div className="flex-1 flex gap-1">
            ...
            <div className="flex-1 flex flex-col gap-1">
              ...
              />
              <div 
                className="h-2 w-1/2 rounded self-end"
                style={{ background: previewColors.surface }}
              />
              <div 
        ...
        {/* Premium badge */}
        {isPremium && (
          <div className="absolute top-2 left-2 flex items-center gap-1 px-1.5 py-0.5 bg-amber-500/90 rounded text-[10px] font-bold text-black">
      ...
      <div className="mt-2 px-1 flex items-center justify-between">
        <div className="text-left">
          ...
          <p className="text-xs text-gray-400 capitalize">{theme.category}</p>
        </div>
  ...
  return (
    <div className="group">
      ...
      <div className="relative h-2 bg-dark-700 rounded-full overflow-hidden">
        <div
          className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary-600 to-primary-400 rounded-full transition-all duration-150"
...
function Toggle({ enabled, onChange, label, description, icon, disabled }: ToggleProps) {
  return (
    <div
      className={`
        flex items-center justify-between p-4 bg-dark-800/50 rounded-lg border border-dark-700
        ${disabled ? 'opacity-50' : 'hover:border-dark-600'}
        transition-colors
      `}
    >
      <div className="flex items-center gap-3">
        {icon && (
          <div className={`text-gray-400 ${enabled ? 'text-primary-400' : ''}`}>
            {icon}
          </div>
        )}
        <div>
    ...
    <div className="space-y-8 pb-8">
      ...
      <section>
        ...
        {themeGroups.custom.length > 0 && (
          <div className="mb-6">
            <h4 className="text-sm font-medium text-gray-400 mb-3">Custom Themes</h4>
            <div className="grid grid-cols-3 gap-4">
      ...
      <section>
        ...
        <div className="space-y-6 bg-dark-800/50 rounded-xl p-6 border border-dark-700">
          {/* Font Scale */}
          <Slider
                    ...
                    {mode === 'cozy' ? (
                      <div className="space-y-2 w-full">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            <div className="h-2 w-16 bg-dark-600 rounded" />
                            <div className="h-1.5 w-24 bg-dark-700 rounded mt-1" />
                          </div>
                        </div>
                        <div className="h-3 bg-dark-700 rounded ml-8" />
                      </div>
                    ) : (
                      <div className="space-y-1 w-full">
                        <div className="flex items-center gap-1">
                          ...
                          <div className="h-2 flex-1 bg-dark-700 rounded" />
                        </div>
                        <div className="flex items-center gap-1">
                          <div className="w-4 h-4 rounded-full bg-green-500" />
                          <div className="h-2 w-10 bg-dark-600 rounded" />
                          <div className="h-2 flex-1 bg-dark-700 rounded" />
                        </div>
                      </div>
                    )}
          ...
          <div className="grid grid-cols-3 gap-3">
            {(['none', 'shader'] as const).map((effect) => (
              <button
                ...
                className={`
                  p-3 rounded-lg border transition-all capitalize
              ...
              <div className="grid grid-cols-5 gap-2">
                {(['matrix', 'fluid', 'particles', 'waves', 'neural'] as const).map((variant) => (
                  <button
                    ...
                    className={`
                      py-2 px-3 rounded-lg border text-xs transition-all capitalize
      ...
      <section>
        ...
        <div
          className="p-6 rounded-xl border overflow-hidden relative"
          style={{
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              ...
              >
                ...
                The theme affects colors, and display settings adjust sizing and spacing.
              </p>
            </div>
          </div>
          ...
          {/* Sample input */}
          <div
            className="relative flex items-center gap-2 p-3 rounded-lg"
            style={{
