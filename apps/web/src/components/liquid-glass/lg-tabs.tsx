 ...
 *
 * @module components/liquid-glass/lg-tabs
 */
import {
  useState,
  useRef,
    ...
    <div className={cn('w-full', className)}>
      ...
      <div
        ...
        className={cn(
          ...
          'dark:border-white/[0.08] dark:bg-[rgb(30,32,40)]/50',
      ...
      >
        ...
        <motion.div
          className={cn(
            ...
            'dark:border-white/[0.06] dark:bg-white/[0.08]',
