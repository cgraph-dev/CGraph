      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {/* Backdrop */}
            <motion.div
              className="absolute inset-0 bg-slate-900/20 dark:bg-black/40 backdrop-blur-[6px]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              {/* Header */}
              {(title || description) && (
                <div className="border-b border-slate-200/40 dark:border-white/[0.06] px-6 py-4">
                  {title && (
                    <h2 id="lg-modal-title" className="text-lg font-semibold text-slate-900 dark:text-white">
                      {title}
                    </h2>
                  )}
                  {description && (
              ...
              {/* Footer */}
              {footer && (
                <div className="flex items-center justify-end gap-2 border-t border-slate-200/40 dark:border-white/[0.06] px-6 py-3.5">
                  {footer}
                </div>
              )}
              ...
              <button
                ...
                className={cn(
                  ...
                  'dark:text-gray-500 dark:hover:text-gray-300 dark:hover:bg-white/[0.08]',
