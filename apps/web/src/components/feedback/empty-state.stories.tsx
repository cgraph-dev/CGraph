...
export const WithAction: Story = {
  args: {
    ...
    action: {
      ...
      onClick: () => console.warn('Create clicked'),
    },
  },
};
...
export const Messages: Story = {
  ...
  render: () => <EmptyMessages onStartConversation={() => console.warn('Start conversation')} />,
};
...
export const Conversations: Story = {
  ...
  render: () => <EmptyConversations onNewConversation={() => console.warn('New conversation')} />,
};
...
export const Groups: Story = {
  ...
  render: () => <EmptyGroups onCreateGroup={() => console.warn('Create group')} />,
};
...
export const ErrorState: Story = {
  args: {
    ...
    action: {
      label: 'Retry',
      onClick: () => console.warn('Retry clicked'),
    },
  },
};
