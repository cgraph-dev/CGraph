    ...
    columns.forEach((column) => {
      ...
      column.characters.forEach((char, i) => {
        ...
        if (char.isHead) {
          ...
          color = theme.primaryColor;
          alpha =
            theme.opacity.body * char.opacity * column.opacityMod * layer.opacityMultiplier * 0.95;
          ...
          alpha =
            theme.opacity.body * char.opacity * column.opacityMod * layer.opacityMultiplier * 0.85;
          ...
          color = theme.secondaryColor;
          alpha =
            theme.opacity.body * char.opacity * column.opacityMod * layer.opacityMultiplier * 0.7;
        ...
        this.ctx!.shadowColor = char.isHead
          ? theme.glow.color || theme.primaryColor
          : 'transparent';
        this.ctx!.shadowOffsetX = 0;
        this.ctx!.shadowOffsetY = 0;
