...
export const GREEK_CHARS =
  'ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ' + 'αβγδεζηθικλμνξοπρστυφχψω' + 'ςΆΈΉΊΌΎΏάέήίόύώ';
 ...
 */
export function createWeightedGenerator(chars: string[], weights?: number[]): () => string {
...
export const CHARACTER_PRESETS = {
  ...
  classic: () =>
    getCharacterSet('katakana', undefined, true, false).concat(
