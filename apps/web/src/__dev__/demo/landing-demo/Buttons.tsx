/**
 * Button Components for LandingDemo
 *
 * SignInButton - Animated sign-in button with glowing border
 * SwapButton - Text-swap hover animation button
 */
...
/**
 * SwapButton - Text swap animation on hover
 */
