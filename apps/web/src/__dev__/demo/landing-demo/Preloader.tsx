/**
 * Preloader Component - GAMELAND-Style Loading Animation
 *
 * Features:
 * - 3D terrain background with grid
 * - Star field and energy particles
 * - Animated brand letters with glitch effect
