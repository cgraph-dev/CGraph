...
import {
  ...
  RARITY_COLORS,
  RARITY_FALLBACK,
} from '@/modules/gamification/components/events/EventRewardsDisplay.constants';
import type { RewardCardSize } from '@/modules/gamification/components/events/EventRewardsDisplay.constants';
