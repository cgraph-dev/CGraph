        ...
        >
          {appeals.map((appeal) => (
            <motion.div
              ...
              className="rounded-xl border border-white/5 bg-white/[0.06] p-4"
            >
              {/* Appeal header */}
                  ...
                  {reviewingId === appeal.id ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        rows={2}
                        className="w-full rounded-lg border border-white/10 bg-white/[0.06] px-3 py-2 text-sm text-white placeholder-white/30 focus:border-primary-500 focus:outline-none"
                      />
