    ...
    <>
      ...
      <GlassCard variant="default" className="relative mb-5 overflow-hidden p-6">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/[0.08] bg-dark-800/60 px-4 py-3 text-white placeholder-gray-500 shadow-inner shadow-black/20 transition-all focus:border-primary-500/40 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
        />
      </GlassCard>
      ...
      <GlassCard variant="default" className="relative mb-5 overflow-hidden p-6">
        ...
        <textarea
          ...
          maxLength={300}
          rows={3}
          className="w-full resize-none rounded-xl border border-white/[0.08] bg-dark-800/60 px-4 py-3 text-white placeholder-gray-500 shadow-inner shadow-black/20 transition-all focus:border-primary-500/40 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
        />
      </GlassCard>
      ...
      <GlassCard variant="default" className="relative mb-5 overflow-hidden p-6">
        ...
        <select
          ...
          className="w-full rounded-xl border border-white/[0.08] bg-dark-800/60 px-4 py-3 text-white transition-all focus:border-primary-500/40 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
        >
      ...
      <GlassCard variant="crystal" glow className="relative mb-5 overflow-hidden p-6">
        ...
        <div className="relative h-36 overflow-hidden rounded-xl bg-dark-800/60 ring-1 ring-white/[0.06]">
          {user?.bannerUrl ? (
        ...
        {user?.walletAddress ? (
          <div className="flex items-center gap-3">
            <input
              ...
              disabled
              className="flex-1 rounded-xl border border-white/[0.08] bg-dark-800/60 px-4 py-3 font-mono text-sm text-gray-400 shadow-inner shadow-black/20"
            />
            <button
              type="button"
          ...
          <button
            type="button"
            className="rounded-xl border border-white/[0.08] bg-dark-800/60 px-5 py-3 text-sm font-medium text-white shadow-inner shadow-black/20 transition-all hover:border-primary-500/30 hover:bg-dark-800/80 hover:shadow-primary-500/5"
          >
            Connect Wallet
          </button>
        )}
