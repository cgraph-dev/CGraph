/**
 * Chat Bubble Settings — Tab Components
 *
 * Extracted tab panels for the ChatBubbleSettings page.
 * Each tab handles a specific aspect of bubble customization:
 * Colors, Shape, Effects, Animations, Layout, and Backgrounds.
 *
 * @module modules/settings/components/chat-bubble-tabs
 */
