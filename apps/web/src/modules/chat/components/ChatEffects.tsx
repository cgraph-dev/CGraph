...
const MessageParticles = memo(function MessageParticles({ effect, config }: MessageParticlesProps) {
...
export const TypingIndicator = memo(function TypingIndicator({
  ...
  return <div className={cn('inline-flex items-center', className)}>{renderIndicator()}</div>;
});
