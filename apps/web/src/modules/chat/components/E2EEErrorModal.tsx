            ...
            <GlassCard variant="neon" glow className="relative overflow-hidden">
              ...
              <div className="space-y-3">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={handleCancel}
                  className="w-full rounded-xl border border-gray-600 bg-gray-800/50 px-6 py-3 font-semibold text-gray-300 transition-all hover:border-gray-500 hover:bg-gray-800"
                >
                  Cancel
                </motion.button>
              </div>
