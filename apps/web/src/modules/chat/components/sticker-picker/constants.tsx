...
export const ANIMATION_CONFIGS: Record<string, TargetAndTransition> = {
  bounce: {
    y: [0, -10, 0],
    transition: { repeat: Infinity, duration: durations.slower.ms / 1000 },
  },
  pulse: {
    scale: [1, 1.1, 1],
  ...
  float: {
    y: [0, -10, 0],
    transition: { repeat: Infinity, duration: durations.loop.ms / 1000, ease: 'easeInOut' },
  },
  ...
  jello: {
    ...
    transition: { duration: durations.verySlow.ms / 1000 },
  },
  heartbeat: {
    scale: [1, 1.3, 1, 1.3, 1],
    transition: { repeat: Infinity, duration: durations.ambient.ms / 1000 },
  },
  flash: {
  ...
  spin: {
    rotate: [0, 360],
    transition: { repeat: Infinity, duration: durations.verySlow.ms / 1000, ease: 'linear' },
  },
  none: {},
};
