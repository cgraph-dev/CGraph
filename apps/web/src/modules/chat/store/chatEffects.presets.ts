...
export const MESSAGE_EFFECT_PRESETS: Record<MessageEffect, Omit<MessageEffectConfig, 'effect'>> = {
  ...
  confetti: { intensity: 'high', duration: durations.cinematic.ms, particleCount: 50 },
  fireworks: { intensity: 'high', duration: 2500, particleCount: 30 },
  sparkle: { intensity: 'medium', duration: durations.ambient.ms, particleCount: 20, color: '#ffd700' },
  rainbow: { intensity: 'medium', duration: durations.loop.ms },
  hearts: { intensity: 'medium', duration: durations.loop.ms, particleCount: 15, color: '#ff69b4' },
  stars: { intensity: 'medium', duration: 1800, particleCount: 25, color: '#ffff00' },
  snow: { intensity: 'low', duration: 4000, particleCount: 40 },
  fire: { intensity: 'high', duration: durations.loop.ms, particleCount: 35, color: '#ff4500' },
  electric: { intensity: 'high', duration: durations.ambient.ms, particleCount: 20, color: '#00ffff' },
  glitch: { intensity: 'high', duration: durations.verySlow.ms },
  matrix: { intensity: 'medium', duration: durations.cinematic.ms, color: '#00ff00' },
  bubble: { intensity: 'low', duration: 2500, particleCount: 10 },
  shake: { intensity: 'medium', duration: durations.slower.ms },
  bounce: { intensity: 'low', duration: durations.extended.ms },
  'fade-in': { intensity: 'low', duration: durations.smooth.ms },
  'slide-in': { intensity: 'low', duration: durations.slow.ms },
  zoom: { intensity: 'medium', duration: durations.smooth.ms },
  flip: { intensity: 'medium', duration: durations.dramatic.ms },
  typewriter: { intensity: 'low', duration: durations.ambient.ms },
  'neon-glow': { intensity: 'medium', duration: durations.loop.ms, color: '#ff00ff' },
  holographic: { intensity: 'high', duration: durations.cinematic.ms },
  ...
  sakura: { intensity: 'low', duration: durations.epic.ms, particleCount: 25, color: '#ffb7c5' },
  rain: { intensity: 'low', duration: 4000, particleCount: 50 },
  thunder: { intensity: 'high', duration: durations.verySlow.ms, sound: true },
  explosion: { intensity: 'high', duration: durations.ambient.ms, particleCount: 60, sound: true },
  portal: { intensity: 'high', duration: durations.loop.ms, color: '#7c3aed' },
};
