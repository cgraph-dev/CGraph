...
export default function EventFormFields({
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="relative">
          ...
          <textarea
            ...
            rows={4}
            className="bg-background border-border w-full resize-none rounded-lg border py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
      </div>
      ...
      {/* Recurrence */}
      <div>
        <label className="mb-1 block text-sm font-medium text-foreground">Repeat</label>
        <div className="relative">
      ...
      {/* Max Attendees */}
      <div>
        <label className="mb-1 block text-sm font-medium text-foreground">Max Attendees</label>
        <div className="relative">
