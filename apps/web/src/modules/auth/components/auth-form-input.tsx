      ...
      <div className={`relative ${className}`}>
        <div className="relative">
          ...
          <input
            ref={ref}
            type={inputType}
            className={`peer w-full rounded-xl border bg-white/[0.04] px-4 pb-2 pt-6 text-foreground placeholder-transparent transition-all focus:outline-none focus:ring-2 ${icon ? 'pl-12' : ''} ${isPassword ? 'pr-12' : ''} ${getBorderColor()} `}
            placeholder={label}
            onFocus={handleFocus}
            onBlur={handleBlur}
      ...
      <div className={className}>
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            type={inputType}
            className={`w-full rounded-xl border-0 bg-white/[0.06] px-4 py-3 text-foreground placeholder-foreground-muted/40 transition-all focus:outline-none focus:ring-2 focus:ring-primary-500/30 ${icon ? 'pl-12' : ''} ${isPassword ? 'pr-12' : ''} `}
            onFocus={handleFocus}
            onBlur={handleBlur}
            onChange={handleChange}
            {...props}
    ...
    <div className={className}>
      ...
      <div className="relative">
        ...
        <input
          ref={ref}
          type={inputType}
          className={`w-full rounded-xl border bg-white/[0.04] px-4 py-3 text-foreground placeholder-foreground-muted/40 transition-all focus:scale-[1.01] focus:outline-none focus:ring-2 ${icon ? 'pl-12' : ''} ${isPassword ? 'pr-12' : ''} ${getBorderColor()} `}
          onFocus={handleFocus}
          onBlur={handleBlur}
          onChange={handleChange}
          {...props}
