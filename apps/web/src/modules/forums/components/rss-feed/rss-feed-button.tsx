...
export const RSSFeedButton = memo(function RSSFeedButton({
  ...
  const variantStyles = {
    ...
    minimal:
      'p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/[0.04] dark:hover:text-gray-200',
    compact:
      'bg-gray-100 px-2 py-1 text-xs text-gray-600 hover:bg-gray-200 dark:bg-white/[0.04] dark:text-gray-300 dark:hover:bg-white/[0.06]',
  };
