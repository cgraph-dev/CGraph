 ...
 *
 * Forum themes are now managed through the unified theme system.
 * This file provides backward compatibility exports.
 *
 * @see /stores/theme/index.ts
 */

export { useThemeStore as useForumThemeStore } from '@/stores/theme';

import { useThemeStore } from '@/stores/theme';

export default useThemeStore;

// Legacy type exports for forum themes
...
// Legacy preset reference (with full properties for compatibility)
