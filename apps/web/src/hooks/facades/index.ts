 ...
 * Domain Facade Hooks
 *
 * Discord-style composition hooks that aggregate multiple Zustand stores
 ...
 * - **Primitive selectors**: Each store subscription uses individual fields (Discord pattern)
