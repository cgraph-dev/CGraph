...
const FEATURES = [
  ...
  { icon: '📋', title: 'Forums', desc: 'Reddit-style discussions' },
...
export default function OnboardingScreen({ navigation }: Props) {
  ...
  }, [currentStep, avatarUri, displayName, bio, notifications, user, navigation, animateTransition]);
        ...
        return (
          <View style={styles.stepContent}>
            ...
            <View style={styles.notificationList}>
              {[
                { key: 'messages' as const, title: 'Direct Messages', desc: 'New messages from friends' },
                { key: 'mentions' as const, title: 'Mentions', desc: 'When someone @mentions you' },
                { key: 'friendRequests' as const, title: 'Friend Requests', desc: 'New friend requests' },
              ].map(({ key, title, desc }) => (
                <View key={key} style={[styles.notificationItem, { backgroundColor: colors.surface }]}>
                  <View style={styles.notificationInfo}>
                    ...
                    <Text style={[styles.notificationDesc, { color: colors.textSecondary }]}>{desc}</Text>
                  </View>
                  <Switch
                    ...
                    thumbColor={Platform.OS === 'ios' ? '#fff' : notifications[key] ? colors.primary : '#f4f3f4'}
                  />
                </View>
              ))}
            </View>
          ...
          <View style={styles.stepContent}>
            ...
            <View style={styles.featuresGrid}>
              {FEATURES.map((feature) => (
                <View key={feature.title} style={[styles.featureGridCard, { backgroundColor: colors.surface }]}>
                  ...
                  <Text style={[styles.featureGridDesc, { color: colors.textSecondary }]}>{feature.desc}</Text>
                </View>
              ))}
            </View>
          </View>
