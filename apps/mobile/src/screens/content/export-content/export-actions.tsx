  ...
  return (
    <>
      ...
      <View style={styles.actions}>
        <TouchableOpacity style={styles.previewButton} onPress={onPreview} disabled={isPreviewing}>
          {isPreviewing ? (
        ...
        <TouchableOpacity style={styles.exportButton} onPress={onExport} disabled={isExporting}>
