...
import { iosFeatures, IOSCapabilities } from './ios/IOSFeatures';
import { androidFeatures, AndroidCapabilities, MaterialYouColors } from './android/AndroidFeatures';
...
export { iosFeatures } from './ios/IOSFeatures';
export { androidFeatures } from './android/AndroidFeatures';
