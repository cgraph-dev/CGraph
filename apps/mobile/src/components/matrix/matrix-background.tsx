 ...
 */
const MatrixColumn = memo<MatrixColumnProps>(
  function MatrixColumn({ column, theme, fontSize, containerHeight, speedMultiplier }) {
    ...
    return (
      <Animated.View style={[styles.column, { left: column.x }, animatedStyle]}>
