defmodule CGraph.Cosmetics.Nameplate do
  @moduledoc """
  Schema for nameplates that users can unlock and equip on their profiles.

  Nameplates provide customizable background, text color, and border styling
  with optional animation support, using the unified 7-tier rarity system.
  """
  use Ecto.Schema
  ...
  def changeset(nameplate, attrs) do
    nameplate
    |> cast(attrs, [
      :slug, :name, :background_url, :text_color, :border_style,
      :rarity, :unlock_type, :unlock_condition, :animated,
