defmodule CGraph.Gamification.UserQuest do
  ...
  """
  @spec progress_changeset(%__MODULE__{}, String.t(), integer()) :: Ecto.Changeset.t()
  ...
  """
  @spec complete_changeset(%__MODULE__{}) :: Ecto.Changeset.t()
  ...
  """
  @spec claim_changeset(%__MODULE__{}) :: Ecto.Changeset.t()
