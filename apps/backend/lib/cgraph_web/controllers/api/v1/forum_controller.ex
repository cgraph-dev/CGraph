defmodule CGraphWeb.API.V1.ForumController do
  ...
  # ============================================================================
  # Forum Voting (Competition) — delegated to VotingActions
  # ============================================================================

  alias CGraphWeb.API.V1.ForumController.VotingActions

  defdelegate vote(conn, params), to: VotingActions
  defdelegate get_vote(conn, params), to: VotingActions
  defdelegate remove_vote(conn, params), to: VotingActions
